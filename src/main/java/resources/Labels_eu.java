...
public class Labels_eu extends ListResourceBundle{
    private static final Object[][] contents = {
        ...
        {"author", "Egilea"},
        /**/
        {"createAdvertisement", "Advertisement sortu"},
        {"editAdvertisement", "Advertisement editatu"},
        {"deleteAdvertisement", "Advertisement borratu"},
        {"src", "Src"},
        {"url", "Url"},
        {"advertLang", "Advertisement-eko hizkuntza"},
        {"sessionLang", "Sesioko hizkuntza"},
