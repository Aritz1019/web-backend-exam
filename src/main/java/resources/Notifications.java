...
public class Notifications extends ListResourceBundle{
    private static final Object[][] contents = {
        ...
        {"message.createAdvertisement", "Advertisement has been created"},
        {"error.createAdvertisement", "Problems creating the advertisement."},
        {"message.editAdvertisement", "Advertisement has been edited"},
        {"error.editAdvertisement", "Problems editing the advertisement"},
        {"message.deleteAdvertisement", "Advertisement has been deleted"},
        {"error.deleteAdvertisement", "Problems deleting the advertisement"},
        //Errors
