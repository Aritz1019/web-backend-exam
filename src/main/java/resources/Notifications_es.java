...
public class Notifications_es extends ListResourceBundle{
    private static final Object[][] contents = {
        ...
        {"message.createAdvertisement", "Se ha creado el anuncio."},
        {"error.createAdvertisement", "Problemas al crear el anuncio."},
        {"message.editAdvertisement", "Anuncio editado."},
        {"error.editAdvertisement", "Problemas al editar el anuncio."},
        {"message.deleteAdvertisement", "Anuncio eliminado."},
        {"error.deleteAdvertisement", "Problemas al eliminar el anuncio."},
        //Errors
